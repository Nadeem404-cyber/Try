...
██║░░██║██████╔╝██║░░██║██████╔╝
╚═╝░░╚═╝╚═════╝░╚═╝░░╚═╝╚═════╝░       
\033[1:91m   Behind every successful Coder there an even more successful De-coder to understand that code
\033[1;91m iTx roy      
...
def log_menu():
	...
	print 47 * '-'
        ...
        print '\033[1;97m[3] Follow Mr-ROY On Fb'
        print ''
        log_menu_s()
...
def menu():
    ...
    print '\033[1;91m[2] Follow Mr-Asad'
                ...
                if 'loc' in q:
                    ...
                    if 'loc' in q:
                        ...
                        if 'loc' in q:
                            ...
                            print '\033[1;91m[ROY-CP]➤ ' + uid + ' | ' + pass4
